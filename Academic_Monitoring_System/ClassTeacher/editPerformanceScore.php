...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM tblperformance WHERE id = '$id'";
    ...
    if ($result->num_rows == 1) {
        ...
        if (isset($_POST['update'])) {
            ...
            $updateQuery = "UPDATE tblperformance SET grade = '$newScoreGrade' WHERE id = '$id'";
            if ($conn->query($updateQuery) === TRUE) {
                ...
                echo "<script>
                        setTimeout(function() {
                            window.location.href = 'performanceTasks.php?subject=" . urlencode($selectedSubject) . "'; // Include subject information in the URL
    ...
    header("Location: performanceTasks.php"); // Replace with the actual URL of the previous page
    exit();
}
?>
