...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM tblquarterly WHERE id = '$id'";
    ...
    if ($result->num_rows == 1) {
        ...
        if (isset($_POST['update'])) {
            ...
            $updateQuery = "UPDATE tblquarterly SET grade = '$newScoreGrade' WHERE id = '$id'";
            if ($conn->query($updateQuery) === TRUE) {
                ...
                echo "<script>
                        setTimeout(function() {
                            window.location.href = 'quarterlyAssessment.php?subject=" . urlencode($selectedSubject) . "'; // Include subject information in the URL
    ...
    header("Location: quarterlyAssessment.php"); // Replace with the actual URL of the previous page
    exit();
}
?>
