...
// Construct the SQL query to fetch written works data for the selected subject and admission number
   $query = "SELECT tblperformance.*, tblterm.termName 
          FROM tblperformance 
          JOIN tblterm ON tblperformance.termId = tblterm.Id 
          WHERE tblperformance.subjectName = '$selectedSubject' AND tblperformance.studentId = '$admissionNumber'";
            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Performance Task / <?php echo htmlspecialchars($selectedSubject); ?></h1>
                    </div>
                                    ...
                                    <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($result) && $result->num_rows > 0) {
                                                ...
                                                echo '<tr><td colspan="5">No performance task data found for the selected subject.</td></tr>';
                                            }
                                            ?>
                                        </tbody>
                                    </table>
    ...
    <script>
        ...
        $(document).ready(function () {
            $(".mark-as-done").on("click", function () {
                ...
                $.ajax({
                    url: 'markAsDone1.php', // Create a new PHP file for handling the update
                    method: 'POST',
                    data: { id: id },
