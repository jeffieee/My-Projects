...
include '../Includes/session.php';
 ...
 $query = "SELECT * FROM tblstudents WHERE Id = ".$_SESSION['userId']."";
  ...
  $admissionNum = $rows['admissionNumber'];
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                   <h1 class="h3 mb-0 text-gray-800"><?php 
                    echo'('.$rows['admissionNumber'].') '.$rows['firstName'].' '.$rows['lastName'].'';
                 ?></h1>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  ...
                  <?php
                    ...
                    if(isset($_POST['view'])){
                       ...
                       if($type == "1"){ //All Attendance
                        ...
                        where tblattendance.admissionNo = '$admissionNum' and tblattendance.classId = '$_SESSION[classId]' and tblattendance.classArmId = '$_SESSION[classArmId]'";
                       ...
                       if($type == "2"){ //Single Date Attendance
                        ...
                        INNER JOIN tblterm ON tblterm.Id = tblsessionterm.termId
                        INNER JOIN tblstudents ON tblstudents.admissionNumber = tblattendance.admissionNo
                        where tblattendance.dateTimeTaken = '$singleDate' and tblattendance.admissionNo = '$admissionNum' and tblattendance.classId = '$_SESSION[classId]' and tblattendance.classArmId = '$_SESSION[classArmId]'";
                       ...
                       if($type == "3"){ //Date Range Attendance
                        ...
                        INNER JOIN tblterm ON tblterm.Id = tblsessionterm.termId
                        INNER JOIN tblstudents ON tblstudents.admissionNumber = tblattendance.admissionNo
                        where tblattendance.dateTimeTaken between '$fromDate' and '$toDate' and tblattendance.admissionNo = '$admissionNum' and tblattendance.classId = '$_SESSION[classId]' and tblattendance.classArmId = '$_SESSION[classArmId]'";
