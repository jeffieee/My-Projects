...
if(isset($_POST['save'])){
    ...
    $query=mysqli_query($conn,"select * from tblsubjects where subjectName ='$subjectName' and classId = '$classId'");
    ...
    if($ret > 0){ 
        ...
        $query=mysqli_query($conn,"insert into tblsubjects(classId,subjectName,isAssigned) value('$classId','$subjectName','0')");
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
  {
        ...
        if(isset($_POST['update'])){
            ...
            $query=mysqli_query($conn,"update tblsubjects set classId = '$classId', subjectName='$subjectName' where Id='$Id'");
