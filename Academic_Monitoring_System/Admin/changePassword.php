...
if (isset($_POST['save'])) {
    ...
    // Verify old password
    $selectQuery = mysqli_query($conn, "SELECT password FROM tbladmin WHERE emailAddress = '$email'");
    ...
    if ($oldPass == $decryptedOldPass) {
        ...
        $updateQuery = mysqli_query($conn, "UPDATE tbladmin SET password = '$encryptedNewPass' WHERE emailAddress = '$email'");
