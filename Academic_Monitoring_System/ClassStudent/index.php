  ...
  <div id="wrapper">
    ...
    <div class="row justify-content-center">
        <div class="col-m-1 align-items-center">
           <?php
$query1 = "SELECT remarks
            FROM tblremarks
            WHERE termId = ? AND admissionNumber = ?";

// Using prepared statement to prevent SQL injection
$stmt = $conn->prepare($query1);
$stmt->bind_param("ii", $termId, $admissionNumber);
$stmt->execute();
$stmt->bind_result($remarks);
$stmt->fetch();
$stmt->close();

echo '<span style="font-weight: bold; text-align: center;">' . htmlspecialchars($remarks) . '</span>';
?>
