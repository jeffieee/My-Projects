...
if (isset($_GET['subject'])) {
    ...
    // Construct the SQL query to fetch quarterly assessment data for the selected subject
    $admissionNumber = $_SESSION['admissionNumber'];

    // Construct the SQL query to fetch quarterly assessment data for the selected subject and admission number
    $query = "SELECT tblquarterly.*, tblterm.termName 
          FROM tblquarterly 
          JOIN tblterm ON tblquarterly.termId = tblterm.Id 
          WHERE tblquarterly.subjectName = '$selectedSubject' AND tblquarterly.studentId = '$admissionNumber'";
            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Quarterly Assessment / <?php echo htmlspecialchars($selectedSubject); ?></h1>
                    </div>
                                    ...
                                    <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($result) && $result->num_rows > 0) {
                                                ...
                                                echo '<tr><td colspan="5">No quarterly assessment data found for the selected subject.</td></tr>';
                                            }
                                            ?>
                                        </tbody>
                                    </table>
    ...
    <script>
        ...
        $(document).ready(function () {
            $(".mark-as-done").on("click", function () {
                ...
                $.ajax({
                    url: 'markAsDone2.php', // Create a new PHP file for handling the update
                    method: 'POST',
                    data: { id: id },
        ...
        $("#exportBtn").on("click", function () {
            ...
            var tableData = [
                ["#", "Subject", "Assessment Name", "Score", "Term"],
            ...
            var fileName = "quarterly_data.xlsx";
