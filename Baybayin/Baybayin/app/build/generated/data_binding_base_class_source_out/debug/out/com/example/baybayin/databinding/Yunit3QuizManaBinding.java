...
public final class Yunit3QuizManaBinding implements ViewBinding {
  @NonNull
  ...
  private Yunit3QuizManaBinding(@NonNull RelativeLayout rootView, @NonNull Button backBtn,
  ...
  @NonNull
  public static Yunit3QuizManaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static Yunit3QuizManaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.yunit3_quiz_mana, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static Yunit3QuizManaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Yunit3QuizManaBinding((RelativeLayout) rootView, backBtn, cardView, choices1,
