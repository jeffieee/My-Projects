...
public final class NoteItemBinding implements ViewBinding {
  ...
  private NoteItemBinding(@NonNull RelativeLayout rootView, @NonNull TextView noteContent,
      @NonNull TextView noteTitle, @NonNull TextView timeOutput) {
  ...
  public static NoteItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NoteItemBinding((RelativeLayout) rootView, noteContent, noteTitle, timeOutput);
    }
