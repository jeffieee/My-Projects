...
public final class Yunit3QuizTaWaBinding implements ViewBinding {
  @NonNull
  ...
  private Yunit3QuizTaWaBinding(@NonNull RelativeLayout rootView, @NonNull Button backBtn,
  ...
  @NonNull
  public static Yunit3QuizTaWaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static Yunit3QuizTaWaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.yunit3_quiz_ta_wa, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static Yunit3QuizTaWaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Yunit3QuizTaWaBinding((RelativeLayout) rootView, backBtn, cardView, choices1,
