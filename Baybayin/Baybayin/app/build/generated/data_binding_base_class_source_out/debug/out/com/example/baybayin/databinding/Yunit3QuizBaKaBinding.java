...
public final class Yunit3QuizBaKaBinding implements ViewBinding {
  @NonNull
  ...
  private Yunit3QuizBaKaBinding(@NonNull RelativeLayout rootView, @NonNull Button backBtn,
  ...
  @NonNull
  public static Yunit3QuizBaKaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static Yunit3QuizBaKaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.yunit3_quiz_ba_ka, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static Yunit3QuizBaKaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Yunit3QuizBaKaBinding((RelativeLayout) rootView, backBtn, cardView, choices1,
