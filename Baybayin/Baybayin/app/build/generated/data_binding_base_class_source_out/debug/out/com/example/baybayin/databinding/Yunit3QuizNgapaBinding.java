...
public final class Yunit3QuizNgapaBinding implements ViewBinding {
  @NonNull
  ...
  private Yunit3QuizNgapaBinding(@NonNull RelativeLayout rootView, @NonNull Button backBtn,
  ...
  @NonNull
  public static Yunit3QuizNgapaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static Yunit3QuizNgapaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.yunit3_quiz_ngapa, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static Yunit3QuizNgapaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Yunit3QuizNgapaBinding((RelativeLayout) rootView, backBtn, cardView, choices1,
