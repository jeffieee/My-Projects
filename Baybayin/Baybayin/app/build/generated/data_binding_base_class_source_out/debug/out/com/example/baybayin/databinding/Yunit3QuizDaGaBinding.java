...
public final class Yunit3QuizDaGaBinding implements ViewBinding {
  @NonNull
  ...
  private Yunit3QuizDaGaBinding(@NonNull RelativeLayout rootView, @NonNull Button backBtn,
  ...
  @NonNull
  public static Yunit3QuizDaGaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static Yunit3QuizDaGaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.yunit3_quiz_da_ga, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static Yunit3QuizDaGaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Yunit3QuizDaGaBinding((RelativeLayout) rootView, backBtn, cardView, choices1,
