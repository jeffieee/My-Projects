...
public final class Yunit1QuizBinding implements ViewBinding {
  @NonNull
  ...
  private Yunit1QuizBinding(@NonNull RelativeLayout rootView, @NonNull Button backBtn,
  ...
  @NonNull
  public static Yunit1QuizBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static Yunit1QuizBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.yunit1_quiz, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static Yunit1QuizBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Yunit1QuizBinding((RelativeLayout) rootView, backBtn, cardView, choices1, choices2,
