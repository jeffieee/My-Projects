...
public final class Yunit3QuizRaSaBinding implements ViewBinding {
  @NonNull
  ...
  private Yunit3QuizRaSaBinding(@NonNull RelativeLayout rootView, @NonNull Button backBtn,
  ...
  @NonNull
  public static Yunit3QuizRaSaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static Yunit3QuizRaSaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.yunit3_quiz_ra_sa, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static Yunit3QuizRaSaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Yunit3QuizRaSaBinding((RelativeLayout) rootView, backBtn, cardView, choices1,
