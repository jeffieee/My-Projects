...
public final class FragmentNoteBinding implements ViewBinding {
  ...
  private FragmentNoteBinding(@NonNull RelativeLayout rootView, @NonNull Button addNote,
  ...
  public static FragmentNoteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.addNote;
      Button addNote = ViewBindings.findChildViewById(rootView, id);
      if (addNote == null) {
        break missingId;
      }
      ...
      return new FragmentNoteBinding((RelativeLayout) rootView, addNote, recyclerView);
    }
