...
public final class Yunit3QuizHaLaBinding implements ViewBinding {
  @NonNull
  ...
  private Yunit3QuizHaLaBinding(@NonNull RelativeLayout rootView, @NonNull Button backBtn,
  ...
  @NonNull
  public static Yunit3QuizHaLaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static Yunit3QuizHaLaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.yunit3_quiz_ha_la, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static Yunit3QuizHaLaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new Yunit3QuizHaLaBinding((RelativeLayout) rootView, backBtn, cardView, choices1,
