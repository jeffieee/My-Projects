...
import static com.example.baybayin.Fragment.Home.Yunit3_hala;
...
import com.example.baybayin.databinding.Yunit1QuizBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //to store the quiz score
            ...
            backBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(Yunit1_Quiz.this, MainActivity.class);
        ...
        d_magpatuloy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.commit();
                Intent intent = new Intent(com.example.baybayin.Quiz.Yunit1_Quiz.this, MainActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
        ...
        f_ulitin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.commit();
                Intent intent = new Intent(com.example.baybayin.Quiz.Yunit1_Quiz.this, Quiz_Note.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
            }
        });
