...
import static com.example.baybayin.Fragment.Home.Yunit3_pagsulat;
import static com.example.baybayin.Fragment.Home.Yunit3_ya;
...
import com.example.baybayin.databinding.Yunit3QuizYaBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        d_magpatuloy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                editor.putString(Yunit3_pagsulat,"pagsulat");
                editor.commit();
                Intent intent = new Intent(Yunit3_Quiz_Ya.this, MainActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
