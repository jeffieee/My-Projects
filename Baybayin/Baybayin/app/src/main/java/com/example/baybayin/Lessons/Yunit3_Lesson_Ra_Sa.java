...
import static com.example.baybayin.Fragment.Profile.Yunit3_Nga_pa;
...
import com.example.baybayin.databinding.Yunit3LessonNgaPaBinding;
import com.example.baybayin.databinding.Yunit3LessonRaSaBinding;
        ...
        setContentView(binding.getRoot());
            ...
            binding.susunod.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    editor.commit();
                    Intent intent = new Intent(Yunit3_Lesson_Ra_Sa.this, com.example.baybayin.Quiz_Note.Quiz_Note.class);
