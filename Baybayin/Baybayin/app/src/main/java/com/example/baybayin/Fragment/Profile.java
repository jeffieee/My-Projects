...
import com.example.baybayin.databinding.FragmentProfileBinding;
...
public class Profile extends Fragment {
    ...
    public static final String Letrang_Nasulatba= "Letrang_Nasulatba";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        scoreba = preferences.getInt(Letrang_Nasulatba, 0);
        ...
        score = scoreA + scoreEI + scoreOU + scoreba+scoredara + scorega + scoreha + scoreka +
        scorela + scorema + scorena + scorenga + scorepa + scoresa + scoreta + scorewa + scoreya;

        yunit2DrawingScore = scoreA + scoreEI + scoreOU;
        yunit3DrawingScore = scoreba+scoredara + scorega + scoreha + scoreka +
                scorela + scorema + scorena + scorenga + scorepa + scoresa + scoreta + scorewa + scoreya;
    ...
    aveQuizScore = ((quizScore * 100)/50)/2;
        ...
        percentage = (score * 100 )/ 17;
        letrangNasulat.setText(score + " / 17");
