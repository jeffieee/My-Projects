...
import static com.example.baybayin.Fragment.Profile.Yunit2DrawingScore;
import static com.example.baybayin.Fragment.Profile.Yunit3DrawingScore;
import static com.example.baybayin.Quiz.Yunit1_Quiz.Yunit1_Quiz_Score;
import static com.example.baybayin.Quiz.Yunit2_Quiz.Yunit2_Quiz_Score;
import static com.example.baybayin.Quiz.Yunit3_Quiz_BaKa.Yunit3_Quiz_1_Score;
import static com.example.baybayin.Quiz.Yunit3_Quiz_DaGa.Yunit3_Quiz_2_Score;
import static com.example.baybayin.Quiz.Yunit3_Quiz_HaLa.Yunit3_Quiz_3_Score;
import static com.example.baybayin.Quiz.Yunit3_Quiz_Mana.Yunit3_Quiz_4_Score;
import static com.example.baybayin.Quiz.Yunit3_Quiz_Ngapa.Yunit3_Quiz_5_Score;
import static com.example.baybayin.Quiz.Yunit3_Quiz_RaSa.Yunit3_Quiz_6_Score;
import static com.example.baybayin.Quiz.Yunit3_Quiz_TaWa.Yunit3_Quiz_7_Score;
import static com.example.baybayin.Quiz.Yunit3_Quiz_Ya.Yunit3_Quiz_8_Score;
...
import com.example.baybayin.Lessons.Yunit1_Lesson_Kahalagahan;
import com.example.baybayin.Lessons.Yunit1_Lesson_Pagsisimula;
import com.example.baybayin.Lessons.Yunit2_Lesson_Introduction;
import com.example.baybayin.Lessons.Yunit2_Lesson_Patinig;
import com.example.baybayin.Lessons.Yunit3_Lesson_Ba_Ka;
import com.example.baybayin.Lessons.Yunit3_Lesson_Da_Ga;
import com.example.baybayin.Lessons.Yunit3_Lesson_Ha_La;
import com.example.baybayin.Lessons.Yunit3_Lesson_Introduction;
import com.example.baybayin.Lessons.Yunit3_Lesson_Ma_Na;
import com.example.baybayin.Lessons.Yunit3_Lesson_Nga_Pa;
import com.example.baybayin.Lessons.Yunit3_Lesson_Ra_Sa;
import com.example.baybayin.Lessons.Yunit3_Lesson_Ta_Wa;
import com.example.baybayin.Lessons.Yunit3_Lesson_Ya;
import com.example.baybayin.Quiz.Yunit3_Pagsulat;
import com.example.baybayin.R;
import com.example.baybayin.databinding.FragmentHomeBinding;
...
public class Home extends Fragment {
    ...
    private String Yunit3Pagsutlat;
    private int yunit1;
    private int yunit2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Yunit3Pagsutlat = preferences.getString(Yunit3_pagsulat, null);
        ...
        TextView yunit2DrawingScore = binding.yunit2DrawingScore;
        ...
        TextView yunit3DrawingScore = binding.yunit3DrawingScore;
        ...
        if (Yunit2_DrawingScore != 0){
            yunit2DrawingScore.setText(Yunit2_DrawingScore + " / 3");
        }else {
            yunit2DrawingScore.setText("- / 3");
        }
        if (yunit3_1 != 0){
        ...
        if (Yunit3_DrawingScore != 0){
            yunit3DrawingScore.setText(Yunit3_DrawingScore + " / 13");
        }else {
            yunit3DrawingScore.setText("- / 13");
        }
        ...
        View.OnClickListener clickListener = v -> {
            if (v == binding.Pagsisimula){
                ...
                if (key != null){
                    Intent intent = new Intent(requireContext(), com.example.baybayin.Quiz.Yunit2_Pagsulat.class);
                    startActivity(intent);
                }else {
                    w_dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                    w_dialog.show();
